...
function Facebookbot(configuration) {
    ...
    var appsecret_prooves = setAppSecretProoves(configuration);

    // Create a core botkit bot
    var facebook_botkit = Botkit(configuration || {});


    // For backwards-compatibility, support the receive_via_postback config option
    ...
    facebook_botkit.middleware.format.use(function(bot, message, platform_message, next) {
        ...
        platform_message.page = message.page;
    ...
    facebook_botkit.defineBot(function(botkit, config) {
        ...
        bot.send = function(message, cb) {
            ...
            message.access_token = resolveAccessToken(message.page);

            if (facebook_botkit.config.require_appsecret_proof) {
                message.appsecret_proof = resolveAppSecretProof(message.page);
            }
        ...
        bot.getMessageUser = function(message, cb) {
            return new Promise(function(resolve, reject) {
                facebook_botkit.api.user_profile(message).then(function(identity) {
    ...
    facebook_botkit.getInstanceInfo = function(page_id, cb) {
        return new Promise(function(resolve, reject) {
            var uri = 'https://' + api_host + '/' + api_version + '/me?access_token=' + resolveAccessToken(page_id);
            ...
            if (facebook_botkit.config.require_appsecret_proof) {
                uri += '&appsecret_proof=' + resolveAppSecretProof(page_id);
            }
    ...
    facebook_botkit.middleware.categorize.use(function handleOptIn(bot, message, next) {
        ...
        if (message.referral && message.type != 'facebook_postback') {
    ...
    var messenger_profile_api = {
        greeting: function(payload, page_id) {
            var message = {
                'greeting': []
            };
            ...
            return facebook_botkit.api.messenger_profile.postAPI(message, page_id);
        },
        delete_greeting: function(page_id) {
            return facebook_botkit.api.messenger_profile.deleteAPI('greeting', page_id);
        },
        get_greeting: function(page_id, cb) {
            return facebook_botkit.api.messenger_profile.getAPI('greeting', page_id, cb);
        },
        get_started: function(payload, page_id) {
            var message = {
                'get_started': {
                    'payload': payload
                }
        ...
        delete_get_started: function(page_id) {
            return facebook_botkit.api.messenger_profile.deleteAPI('get_started', page_id);
        },
        get_get_started: function(page_id, cb) {
            return facebook_botkit.api.messenger_profile.getAPI('get_started', page_id, cb);
        },
        menu: function(payload, page_id) {
            var message = {
                persistent_menu: payload
            };
            return facebook_botkit.api.messenger_profile.postAPI(message, page_id);
        },
        delete_menu: function(page_id) {
            return facebook_botkit.api.messenger_profile.deleteAPI('persistent_menu', page_id);
        },
        get_menu: function(page_id, cb) {
            return facebook_botkit.api.messenger_profile.getAPI('persistent_menu', page_id, cb);
        },
        account_linking: function(payload, page_id) {
            var message = {
                'account_linking_url': payload
            };
            return facebook_botkit.api.messenger_profile.postAPI(message, page_id);
        },
        delete_account_linking: function(page_id) {
            return facebook_botkit.api.messenger_profile.deleteAPI('account_linking_url', page_id);
        },
        get_account_linking: function(page_id, cb) {
            return facebook_botkit.api.messenger_profile.getAPI('account_linking_url', page_id, cb);
        },
        domain_whitelist: function(payload, page_id) {
            var message = {
                'whitelisted_domains': Array.isArray(payload) ? payload : [payload]
            };
            return facebook_botkit.api.messenger_profile.postAPI(message, page_id);
        },
        delete_domain_whitelist: function(page_id) {
            return facebook_botkit.api.messenger_profile.deleteAPI('whitelisted_domains', page_id);
        },
        get_domain_whitelist: function(page_id, cb) {
            return facebook_botkit.api.messenger_profile.getAPI('whitelisted_domains', page_id, cb);
        },
        target_audience: function(payload, page_id) {
            var message = {
                'target_audience': payload
            };
            return facebook_botkit.api.messenger_profile.postAPI(message, page_id);
        },
        delete_target_audience: function(page_id) {
            return facebook_botkit.api.messenger_profile.deleteAPI('target_audience', page_id);
        },
        get_target_audience: function(page_id, cb) {
            return facebook_botkit.api.messenger_profile.getAPI('target_audience', page_id, cb);
        },
        home_url: function(payload, page_id) {
            var message = {
                home_url: payload
            };
            return facebook_botkit.api.messenger_profile.postAPI(message, page_id);
        },
        delete_home_url: function(page_id) {
            return facebook_botkit.api.messenger_profile.deleteAPI('home_url', page_id);
        },
        get_home_url: function(page_id, cb) {
            return facebook_botkit.api.messenger_profile.getAPI('home_url', page_id, cb);
        },
        payment_settings: function(payload, page_id) {
            var message = {
                payment_settings: payload
            };
            return facebook_botkit.api.messenger_profile.postAPI(message, page_id);
        },
        delete_payment_settings: function(page_id) {
            return facebook_botkit.api.messenger_profile.deleteAPI('payment_settings', page_id);
        },
        get_payment_settings: function(page_id, cb) {
            return facebook_botkit.api.messenger_profile.getAPI('payment_settings', page_id, cb);
        },
        postAPI: function(message, page_id) {
            return new Promise(function(resolve, reject) {
                var uri = 'https://' + api_host + '/' + api_version + '/me/messenger_profile?access_token=' + resolveAccessToken(page_id);
        ...
        deleteAPI: function(type, page_id) {
            return new Promise(function(resolve, reject) {
                var uri = 'https://' + api_host + '/' + api_version + '/me/messenger_profile?access_token=' + resolveAccessToken(page_id);
        ...
        getAPI: function(fields, page_id, cb) {
            return new Promise(function(resolve, reject) {
                var uri = 'https://' + api_host + '/' + api_version + '/me/messenger_profile?fields=' + fields + '&access_token=' + resolveAccessToken(page_id);
        ...
        get_messenger_code: function(image_size, cb, ref) {
            var uri = 'https://' + api_host + '/' + api_version + '/me/messenger_codes?access_token=' + resolveAccessToken(page_id);
    ...
    var attachment_upload_api = {
        upload: function(attachment, page_id, cb) {
            var uri = 'https://' + api_host + '/' + api_version + '/me/message_attachments?access_token=' + resolveAccessToken(page_id);
    ...
    var tags = {
        get_all: function(page_id, cb) {
            var uri = 'https://' + api_host + '/' + api_version + '/page_message_tags?access_token=' + resolveAccessToken(page_id);
    ...
    var nlp = {
        enable: function(custom_token, page_id) {
            facebook_botkit.api.nlp.postAPI(true, custom_token, page_id);
        },
        disable: function(custom_token, page_id) {
            facebook_botkit.api.nlp.postAPI(false, custom_token, page_id);
        },
        postAPI: function(value, custom_token, page_id) {
            var uri = 'https://' + api_host + '/' + api_version + '/me/nlp_configs?nlp_enabled=' + value + '&access_token=' + resolveAccessToken(page_id);
    ...
    var user_profile = function(uid, fields, page_id, cb) {
        if (!fields) {
            fields = 'first_name,last_name,timezone,gender,locale,email,picture';
        }
        return new Promise(function(resolve, reject) {
            var uri = 'https://' + api_host + '/' + api_version + '/' + uid + '?fields=' + fields + '&access_token=' + resolveAccessToken(page_id);
    ...
    var insights_api = {
        get_insights: function(metrics, since, until, page_id, cb) {
            var uri = 'https://' + api_host + '/' + api_version + '/me/insights?access_token=' + resolveAccessToken(page_id);
    ...
    var handover = {
        get_secondary_receivers_list: function(fields, page_id, cb) {
            ...
            request.get({
                ...
                qs: {
                    ...
                    access_token: resolveAccessToken(page_id)
                },
                json: true
            }, function(err, res, body) {
                if (err) {
        ...
        take_thread_control: function(recipient, metadata, page_id, cb) {
        ...
        pass_thread_control: function(recipient, target, metadata, page_id, cb) {
        ...
        request_thread_control: function(recipient, metadata, page_id, cb) {
        ...
        get_thread_owner: function(recipient, page_id, cb) {
    ...
    var broadcast_api = {
        create_message_creative: function(message, page_id, cb) {
            var uri = 'https://' + api_host + '/' + api_version + '/me/message_creatives?access_token=' + resolveAccessToken(page_id);
        ...
        send: function(message_creative, custom_label_id, page_id, cb) {
            var uri = 'https://' + api_host + '/' + api_version + '/me/broadcast_messages?access_token=' + resolveAccessToken(page_id);
            var body = {};
        ...
        get_broadcast_metrics: function(broadcast_id, page_id, cb) {
            var uri = 'https://' + api_host + '/' + api_version + '/' + broadcast_id + '/insights/messages_sent?access_token=' + resolveAccessToken(page_id);
        ...
        create_label: function(name, page_id, cb) {
            var uri = 'https://' + api_host + '/' + api_version + '/me/custom_labels?access_token=' + resolveAccessToken(page_id);
        ...
        add_user_to_label: function(user, label_id, cb) {
            var uri = 'https://' + api_host + '/' + api_version + '/' + label_id + '/label?access_token=' + resolveAccessToken(page_id);
        ...
        remove_user_from_label: function(user, label_id, page_id, cb) {
            var uri = 'https://' + api_host + '/' + api_version + '/' + label_id + '/label?access_token=' + resolveAccessToken(page_id);
        ...
        get_labels_by_user: function(user, page_id, cb) {
            var uri = 'https://' + api_host + '/' + api_version + '/' + user + '/custom_labels?access_token=' + resolveAccessToken(page_id);
        ...
        get_label_details: function(label_id, fields, page_id, cb) {
            var uri = 'https://' + api_host + '/' + api_version + '/' + label_id + '?access_token=' + resolveAccessToken(page_id);
        ...
        get_all_labels: function(fields, page_id, cb) {
            var uri = 'https://' + api_host + '/' + api_version + '/me/custom_labels?access_token=' + resolveAccessToken(page_id);
        ...
        remove_label: function(label_id, page_id, cb) {
            var uri = 'https://' + api_host + '/' + api_version + '/' + label_id + '?access_token=' + resolveAccessToken(page_id);
        ...
        cancel_scheduled_broadcast: function(broadcast_id, page_id, cb) {
            var uri = 'https://' + api_host + '/' + api_version + '/' + broadcast_id + '?access_token=' + resolveAccessToken(page_id);
            ...
            request({
                ...
                if (err) {
                    ...
                    if (body.error) {
                        facebook_botkit.log('ERROR in cancel scheduled broadcast call : ', body.error);
                        if (cb) {
                            cb(body.error);
                        }
                    } else {
        ...
        get_broadcast_status: function(broadcast_id, fields, page_id, cb) {
            var uri = 'https://' + api_host + '/' + api_version + '/' + broadcast_id + '?access_token=' + resolveAccessToken(page_id);
    ...
    function setAppSecretProoves() {
        var { pages, app_secret, access_token } = configuration;
        ...
        if (configuration.pages) {
            return pages.map(page => {
                ...
                return {
                    id,
                    app_secret_proof: getAppSecretProof(access_token, app_secret)
                };
            });
        } else {
            return [getAppSecretProof(access_token, app_secret)];
        }
    }

    function resolveAppSecretProof(page_id) {
        return configuration.pages ?
            appsecret_prooves.find(proof => proof.id === page_id)
            : appsecret_prooves[0];
    }

    function resolveAccessToken(page_id) {
        return configuration.pages ? getAccessToken(page_id) : configuration.access_token;
    }

    function getAccessToken(page_id) {
        const page = configuration.pages.find(p => p.id === page_id);
